# printf Project(collacoration)

## Description
This team project is part of the fundation curriculum of ALX.
...
* How to collaborate with each other and working on a particular project. 
---
...
* ```_printf("Hello world, main\n")``` *prints "Hello world, Main", followed by a new line*
* ```_printf("%s", "Hello")``` *prints "Hello"*
* ```_printf("This is number: %d", 48)``` *prints "This is number: 48"*
...
### Authors
* **Oladeji Ajayi** - [oladejiajayi05@gmail.com](https://github.com/oladeji21)
* **Sampson Obe** - [obesampson80@gmail.com](https://github.com/obesampson80)
